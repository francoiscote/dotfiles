...
-- Layouts
hs.hotkey.bind(hyper, "q", layouts.workMax)
hs.hotkey.bind(hyperShift, "q", function() 
  grid.setLargeMargins()
  layouts.workMax()
  grid.setDefaultMargins()
end)
hs.hotkey.bind(hyper, "w", layouts.workCodeOrBrowse)
hs.hotkey.bind(hyperShift, "w", function() 
  grid.setLargeMargins()
  layouts.workCodeOrBrowse()
  grid.setDefaultMargins()
end)

hs.hotkey.bind(hyper, "e", layouts.workCode)
hs.hotkey.bind(hyperShift, "e", function() 
  grid.setLargeMargins()
  layouts.workCode()
  grid.setDefaultMargins()
end)
hs.hotkey.bind(hyper, "r", layouts.workBrowse)
hs.hotkey.bind(hyperShift, "e", function() 
  grid.setLargeMargins()
  layouts.workBrowse()
  grid.setDefaultMargins()
end)
hs.hotkey.bind(hyper, "t", layouts.workEven)
...
hs.hotkey.bind(hyper, "5", function()
  grid.setFocusedWindowToCell(areas.custom.spotify)
end)
hs.hotkey.bind(hyperShift, "5", function()
  grid.setFocusedWindowToCell(areas.customTwitch.spotify)
end)
